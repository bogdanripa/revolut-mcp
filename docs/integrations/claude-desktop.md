...
Prefer the [hosted deployment](../getting-started/hosted.md) if you just want the tools — it needs no local install at all. Otherwise point Claude Desktop at your own build.
